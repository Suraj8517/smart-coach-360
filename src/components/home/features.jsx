...
const features =[
  ...
  { num:'008', icon:<Smartphone />,img: IMAGES.crmapp , title:'Mobile App iOS & Android', desc:'Run your entire coaching business from your pocket. Coaches and clients get a seamless mobile experience with real-time updates and integrated health tracking.', tags:['iOS & Android Apps','Client Self-Service','Push Notifications','Health Data Sync'] },
  { num:'009', icon:<ShieldCheck />,img: IMAGES.crmsecurity , title:'Security & Compliance', desc:'Enterprise-grade security built into every plan. Protect sensitive client data with advanced authentication, secure payments, and compliance tools.', tags:['SSO Support','Access Control','PCI-DSS Payments','GDPR Tools'] },
]
