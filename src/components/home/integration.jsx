        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div
                key={i}
                className="relative flex flex-col items-center gap-2.5 rounded-2xl p-4 border transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md cursor-default group"
                style={{
                  background: t.bg,
